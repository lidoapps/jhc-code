/*
 * cn.jhc.ch09.AddBookToCart.java
 * Y2javaee的ch09示例，演示购物车
 */
package cn.jhc.ch09;
...
public class AddBookToCart extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 如果session不存在，转向 /ch09/books.jsp
		if (session == null) {
			dispatcher = request.getRequestDispatcher("/ch09/books.jsp");
		...
		// 转向viewCart.jsp显示购物车
		dispatcher = request.getRequestDispatcher("/ch09/viewCart.jsp");
		dispatcher.forward(request, response);
	}
